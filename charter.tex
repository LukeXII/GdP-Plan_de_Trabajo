...
% Faltaria poner los requerimientos del software de PC. Va a tener GUI? Mostraria lo mismo que la pantalla tactil?
% Podria ser buena idea ponerlos en una nueva seccion de "Requerimientos de la iterfaz"
...
Como ingeniero de desarrollo desearía poder saber el consumo de corriente del EDFA cuando está funcionando activamente sobre una señal óptica para poder calcular su eficiencia.

Como técnico de integración desearía poder probar todas las señales del EDFA rápidamente sin riesgo de dañarlo para realizar una aceptación de lote en poco tiempo.
...
\item Planificación del proyecto ( hs)
	\begin{enumerate}
	\item Definición de alcance y requerimientos con el cliente (6 hs)
	\item Análisis de factibilidad técnico-económica (4 hs)
	\item Confección del plan de trabajo (18 hs)
	\end{enumerate}
\item Análisis preliminar
	\begin{enumerate}
	\item Elección de microcontrolador (4 hs)
	\item Definición de principales componentes a utilizar (8 hs)
	\item Tarea 3 ( hs)
	\end{enumerate}
\item Diseño general del dispositivo
	\begin{enumerate}
	\item Construcción de diagrama en bloques (12 hs)
	\item Definición de interfaces (10 hs)
	\item Tarea 3 ( hs)
	\end{enumerate}
\item Diseño de hardware
	\begin{enumerate}
	\item Diseño del diagrama esquemático (30 hs)
	\item Diseño del PCB (28 hs)
	\item Ensamble del PCB (10 hs)
	\item Puesta en marcha del PCB (8 hs)
	\item Ejecución de retrabajos del PCB (4 hs)
	\item Diseño de la carcasa (18 hs)
	\item Impresión de la carcasa (14 hs)
	\item Integración y montaje del dispositivo completo (6 hs)
	\end{enumerate}
\item Diseño de firmware
	\begin{enumerate}
	\item Definición de la arquitectura (10 hs)
	\item Modularización del código (16 hs)
	\item Tarea 3 ( hs)
	\end{enumerate}
\item Verificación y validación
	\begin{enumerate}
	\item Pruebas de campo ( hs)
	\item Tarea 2 ( hs)
	\item Tarea 3 ( hs)
	\end{enumerate}
\item Documentación
	\begin{enumerate}
	\item Elaboración del manual de usuario (18 hs)
	\item Tarea 2 ( hs)
	\item Tarea 3 ( hs)
	\end{enumerate}
\end{enumerate}
