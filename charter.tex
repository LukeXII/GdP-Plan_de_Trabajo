...
0.1      & Creación del documento.                                 &\fechaInicioName \\ \hline
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en \textcolor{red}{el desarrollo y construcción de un dispositivo integrado capaz de ejecutar pruebas sobre un amplificador de fibra óptica}, y tendrá un presupuesto preliminar estimado de \textcolor{red}{600} hs de trabajo y \textcolor{red}{\$XXX}, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
El presente proyecto se destaca especialmente por incorporar todas los componentes necesarios para poder...
...
El propósito de este proyecto es desarrollar un sistema integrado capaz de 
...
\begin{itemize}
	...
	\item Se cuenta con toda la información técnica a cerca del amplificador óptico.
\end{itemize}
